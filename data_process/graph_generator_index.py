...
def generator_graph_index_by_time():
    horizon = 5
    experiment = "label_2"
    raw_data = pickle_load(f"../dataset/processed_data/v3_feature/raw_data_dict_{experiment}_horizon_{horizon}_2020.pkl")
    ...
    print(f"数据规模：Train: {len(train_data)}, Val: {len(val_data)}")  # 几张图
    ...
    pickle_dump(f"../dataset/processed_data/v3_feature/train_data_index_{experiment}_horizon_{horizon}_2020.pkl", train_data)
    pickle_dump(f"../dataset/processed_data/v3_feature/val_data_index_{experiment}_horizon_{horizon}_2020.pkl", val_data)
